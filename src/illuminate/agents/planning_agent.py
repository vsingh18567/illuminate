...
class PlanningAgent(Agent):
    ...
    Set the PlanningResponse.action to plan if you are outputting a list of steps. Otherwise, set the action to user_question if you need to ask the user a question. Set the action to done if you are done with the project and are outputting a final summary.
    """
